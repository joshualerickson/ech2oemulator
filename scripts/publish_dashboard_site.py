...
<h2>Current reading</h2><p>Among the continued fixed-window LSTMs, the 60-day model has the best pooled validation MAE for soil moisture, AM skin temperature, and both PLC targets; the 90-day model has the best PM skin-temperature MAE. The full-water-year BPTT LSTM uses a continuity-valid 97-site validation subset and is therefore retained as a long-memory diagnostic rather than a direct winner over the fixed-window cohort.</p>
